/obj/map_metadata/konstantinovka
	...
	mission_start_message = "<font size=4>The <b>Defensive side</b> is holding the town. <b>IDF</b> troops must capture the Konstantinovka (SE corner) within <b>40 minutes</b>!</font>"
	faction1 = RUSSIAN
	faction2 = UKRAINIAN
